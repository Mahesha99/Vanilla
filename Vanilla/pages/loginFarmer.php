 ...
 <!-----<div class="brand-title">logo</div>---->
  ...
  <div class="inputs">
	   <p>
				...
				$sql = "SELECT * FROM `farmertb` WHERE `email`='".$email."' AND `password` ='".$password."';";
    ...
    <button type="submit" name="btnsubmit">LOGIN</button><br><br> 
	  	  <mark>DON'T HAVE AN ACCOUNT PLEASE REGISTER HERE<a href="RegFarmer.php">&nbsp;&nbsp;&nbsp;&nbsp;Register here </a>  </mark>
  </div>
